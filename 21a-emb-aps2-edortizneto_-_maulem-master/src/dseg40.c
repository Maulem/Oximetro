...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1, .adv_w = 522, .box_w = 19, .box_h = 3, .ofs_x = 7, .ofs_y = 18},
    {.bitmap_index = 9, .adv_w = 0, .box_w = 5, .box_h = 5, .ofs_x = -2, .ofs_y = 0},
    {.bitmap_index = 13, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 138, .adv_w = 522, .box_w = 4, .box_h = 38, .ofs_x = 25, .ofs_y = 2},
    {.bitmap_index = 157, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 282, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 407, .adv_w = 522, .box_w = 25, .box_h = 38, .ofs_x = 4, .ofs_y = 1},
    {.bitmap_index = 526, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 651, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 776, .adv_w = 522, .box_w = 25, .box_h = 39, .ofs_x = 4, .ofs_y = 2},
    {.bitmap_index = 898, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 1023, .adv_w = 522, .box_w = 25, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 1148, .adv_w = 128, .box_w = 5, .box_h = 22, .ofs_x = 2, .ofs_y = 9}
};
